...
1. **Download the APK**:
   - Download [`SmartBill-v1.0.0.apk`](./SmartBill-v1.0.0.apk) directly to your device or transfer it via USB / Quick Share / WhatsApp.
...
3. **Install**:
   - Tap on the downloaded `SmartBill-v1.0.0.apk` file and select **Install**.
4. **Permissions**:
...
- 💾 **Credential Persistence**: Shopkeeper credentials and profile are remembered across app resets.
- 📊 **Enhanced Reports**: Fixed UI layout layering for smooth, responsive financial summaries and top seller charts.
